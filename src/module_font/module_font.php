<div class="accessibility-option" id="module-font-size" data-bs-custom-class="bg-tooltip" data-tooltip-title="Schriftgröße" data-tooltip-text="Vergrößert die Schrifgröße der Website und kann beliebig angepasst werden." tabindex="0">
